<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ACRP597.aspx.cs" Inherits="ACRP597.ACRP597" %>
    ...
    <div>
        <div class="page">
            <div class="header">
                <div class="title">
                    <h1>
                        Estado de Cuenta Clientes - ACRP597
                    </h1>
                </div>
            ...
            &nbsp;&nbsp
            <asp:Label runat="server" ID="lbl_moneda" Text="Moneda"></asp:Label>
