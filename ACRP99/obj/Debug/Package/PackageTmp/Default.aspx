<%@ Page Title="Página principal" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="ACRP99._Default" %>
 ...
 <div class="Salir">
    ...
    <div>
        ...
        <asp:DropDownList ID="ddl_pais" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Selection_Change"
            ...
            <asp:ListItem Value="4">Perú</asp:ListItem>
            <asp:ListItem Value="5">Trinidad &amp; Tobago</asp:ListItem>
            <asp:ListItem Value="6">Venezuela</asp:ListItem>
            <asp:ListItem Value="7">Prototipo</asp:ListItem>
        </asp:DropDownList>
