...
ORDER BY
	...
	<asp:Panel ID="PanelDocumentos" runat="server" Enabled="False" Visible="False">
		...
		<asp:SqlDataSource ID="SqlDataSourceDocumentos" runat="server" 
			ConnectionString="<%$ ConnectionStrings:BILP500PAcs %>" 
			ProviderName="<%$ ConnectionStrings:BILP500PAcs.ProviderName %>" SelectCommand="SELECT
	SIHL18.SICOMP, SIHL18.SIID, SIHL18.IHDTYP, SIHL18.SFRES, SIHL18.IHDPFX,
	SIHL18.IHDOCN, SIHL18.SILINS, RCML12.CCUST AS CCUST_CLIENTE, 
	RCML12.CNME AS CNME_CLIENTE, RCML12_1.CCUST AS CCUST_FACTURACION, RCML12_1.CNME AS CNME_FACTURACION, 
	SIHL18.SITOT, RARL05.ARCAIN, RARL05.ARHNDL, RARL05.ARODPX, RARL05.ARODTP, 
	SIHL18.SIINVN, RARL05.RIDTE, RARL05.RDDTE, SIHL18.SIINVD
FROM
	SIHL18, RARL05, RCML12, RCML12 RCML12_1
WHERE
	SIHL18.SIINVN = RARL05.RINVC AND SIHL18.IHDPFX = RARL05.ARDPFX AND 
	SIHL18.IHDTYP = RARL05.ARDTYP AND SIHL18.IHDOCN = RARL05.ARDOCN AND SIHL18.SICUST = RCML12.CCUST AND 
	SIHL18.IHINCU = RCML12_1.CCUST AND SIHL18.SICOMP = RARL05.RCOMP AND
	(SIHL18.SICOMP = ?) AND
	(SIHL18.IHDPFX = ?) AND
	(SIHL18.SIINVD BETWEEN ? AND ?) AND
	(SIHL18.IHDTYP BETWEEN ? AND ?)
ORDER BY
	SIHL18.SIINVD DESC, SIHL18.IHDOCN DESC">
			<SelectParameters>
				<asp:ControlParameter ControlID="campoSeleccionDeCompania" 
					ConvertEmptyStringToNull="False" DbType="Decimal" DefaultValue="0" Name="?" 
					PropertyName="SelectedValue" />
...
FROM
	SIHL18, RARL05
WHERE
	SIHL18.SIINVN = RARL05.RINVC AND
	SIHL18.IHDPFX = RARL05.ARDPFX AND
	SIHL18.IHDTYP = RARL05.ARDTYP AND
	SIHL18.IHDOCN = RARL05.ARDOCN AND	
	(SIHL18.IHDTYP = ?) AND
	(SIHL18.IHDPFX = ?) AND
	(SIHL18.IHDOCN = ?) AND
	(SIHL18.SICOMP = ?)" SelectCommandType="StoredProcedure">
			<SelectParameters>
	...
	SILL07.*, IIML02.*
FROM
	{ oj SILL07 LEFT OUTER JOIN
	IIML02 ON SILL07.ILPROD = IIML02.IPROD }
WHERE
	(SILL07.ILDTYP = ?) AND
	(SILL07.ILDPFX = ?) AND
	(SILL07.ILDOCN = ?) AND 
...
FROM
	SIHL18, RARL05
WHERE
	SIHL18.SIINVN = RARL05.RINVC AND SIHL18.IHDPFX = RARL05.ARDPFX AND SIHL18.IHDTYP = RARL05.ARDTYP AND
	(SIHL18.IHDTYP = ?) AND
	(SIHL18.IHDPFX = ?) AND
	(SIHL18.IHDOCN = ?) AND
	(SIHL18.SICOMP = ?)">
