                        ...
                        <div class="panel">
                            <asp:Panel runat="server" ID="panel1" Width="520px" Style="text-align: left; margin-bottom: 0px;"
                                ...
                                <fieldset class="my_fieldset_small">
                                    ...
                                    <asp:MaskedEditExtender ID="MaskedEditExtender1" runat="server" TargetControlID="txt_codigo"
                                        Mask="99" MaskType="Number" MessageValidatorTip="true" InputDirection="RightToLeft"
                                    ...
                                    <asp:TextBox runat="server" ID="txt_peso_std" Text="" Width="50px" Enabled="false">
                                    </asp:TextBox>
                                    <asp:Label runat="server" ID="lbl_peso_min" Text="Peso Mínimo"></asp:Label>
                                    &nbsp
                                    <asp:TextBox runat="server" ID="txt_peso_min" Text="" Width="50px" Enabled="false">
                                    </asp:TextBox>
                                    <asp:Label runat="server" ID="lbl_peso_max" Text="Peso Máximo"></asp:Label>
                                    <asp:TextBox runat="server" ID="txt_peso_max" Text="" Width="50px" Enabled="false">
                                    </asp:TextBox>
                                    <br />
                                    <br />
                                    <asp:Label runat="server" ID="lbl_peso_prom" Text="Peso Promedio"></asp:Label>
                                    <asp:TextBox runat="server" ID="txt_peso_prom" Text="" Width="50px" Enabled="false">
                                    </asp:TextBox>
                                    <asp:Label runat="server" ID="lbl_prod_teor" Text="Producción Teórica"></asp:Label>
                                    <asp:TextBox runat="server" ID="txt_prod_teor" Text="" Width="50px" Enabled="false">
                                    </asp:TextBox>
