...
<body>
    ...
    <div id="divPrint">
        <div class="page">
            <table>
                ...
                <tr>
                    <td>
                        <div class="encabezado_impresion">
                            <asp:ImageButton ID="img_papisa" runat="server" ImageUrl="~/imagenes/papisa.gif"
                ...
                <Columns>
                    ...
                    <asp:TemplateField AccessibleHeaderText="Doc Sistema" HeaderText="Doc Sistema" Visible="False">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("prfo") %>'></asp:Label>
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("prfo") %>'></asp:TextBox>
                    ...
                    <asp:BoundField HeaderText="Referencia" DataField="ref" HeaderStyle-HorizontalAlign="Left"
                        ItemStyle-HorizontalAlign="Left">
                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="Prefijo Orig" DataField="prfo" HeaderStyle-HorizontalAlign="Left"
                        ItemStyle-HorizontalAlign="Left">
                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="Tipo Orig" DataField="tpo" HeaderStyle-HorizontalAlign="Left"
                        ItemStyle-HorizontalAlign="Left">
                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField>
                    <asp:TemplateField AccessibleHeaderText="Fecha Vcmto" HeaderText="Fecha Vcmto" Visible="False">
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("vcto") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("vcto") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:BoundField HeaderText="Fecha Vcmnto" DataField="vcto" HeaderStyle-HorizontalAlign="Left"
                        ItemStyle-HorizontalAlign="Left">
                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField>
        ...
        <%----------------- GridView Resumen  ------------------------%>
        <div class="centrar_GridView">
            <asp:GridView ID="gv_resumen" runat="server" AllowSorting="True" DataKeyNames="sistema"
                CellPadding="4" ForeColor="#333333" GridLines="None" EmptyDataText="No Se Encontraron Registros"
                Width="900px" PageSize="13" OnSorting="gv_resumen_sort" AutoGenerateColumns="False"
                OnRowDataBound="gv_resumen_RowDataBound" ShowFooter="True" 
                onselectedindexchanged="gv_resumen_SelectedIndexChanged">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <EditRowStyle BackColor="#999999" />
                <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
        ...
        <br />
        <asp:Image runat="server" ID="img_firma" ImageUrl="~/imagenes/firma_EdoCta.png" Width="899px" />
        <br />
        <input type="image" runat="server" id="btnPrint" src="~/imagenes/imprimir.gif" onclick="javascript:CallPrint('divPrint')" />
        <asp:ImageButton runat="server" ID="img_pdf" ImageUrl="~/imagenes/pdf texto.jpg" Height="25px"
            Width="168px" OnClick="img_pdf_Click" Visible="false" />
    </div>
    </form>
</body>
</html>
