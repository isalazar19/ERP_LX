...
namespace ERP_LX
{
    public partial class ORDP101 : System.Web.UI.Page
    {
            ...
            switch (param)
            {
                case 1:
                    ...
                    switch (tipo)
                    {
                        ...
                        case "ST": /* STRETCH */
                        case "CA": /* CAPACIDAD */
                            cmdtext = "SELECT PANLXUSRF.ORDPF003.RCDI03 || ' ' || PANLXUSRF.ORDPF003.RDIN03 AS myinsumo, " +
                                     "PANLXUSRF.ORDPF003.RIDR03," +
                                     " PANLXUSRF.ORDPF003.RITE03," +
                                     " IIML01.IDESC," +
                                     " PANLXUSRF.ORDPF003.RCEN03," +
                                     "PANLXUSRF.ORDPF003.RINS03, " +
                                      "PANLXUSRF.ORDPF003.RIUM03 " +
                                     "FROM PANLXUSRF.ORDPF003, IIML01 " +
                                    "WHERE ( PANLXUSRF.ORDPF003.RITE03 = IIML01.IPROD ) and  " +
                                    "      ( ( PANLXUSRF.ORDPF003.RIDR03 = '" + ddl_tipo.SelectedValue.ToString() + "' ) )";
                        ...
                        case "PT": /* PALETAS */
                            cmdtext = "SELECT PANLXUSRF.ORDPF003.RCDI03 || ' ' || PANLXUSRF.ORDPF003.RDIN03 AS myinsumo, " +
                                      ...
                                      "PANLXUSRF.ORDPF003.RINS03, " +
                                      "PANLXUSRF.ORDPF003.RIUM03 " +
                                      "FROM PANLXUSRF.ORDPF003 " +
                                     "WHERE PANLXUSRF.ORDPF003.RIDR03 = '" + ddl_tipo.SelectedValue.ToString() + "'";
                ...
                case 2:
                    ...
                    switch (tipo)
                    {
                        ...
                        case "ST":
                        case "CA":
                        Select = "SELECT RIUM03,RMIN03,RMAX03,RPRO03,RQTY03 from PANLXUSRF.ORDPF003 " +
        ...
        protected void llenar_art()
        {
            ...
            {
                iDB2Connection con = new iDB2Connection(conexion);
                string cmdtext = "SELECT IPROD, IPROD||'-'||IDESC AS miprod FROM IIML01 ";
        ...
        protected void b_eliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (tipo)
                {
                    ...
                    case "ST":
                    case "CA":
                        Select.CommandText = "DELETE from PANLXUSRF.ORDPF003 " +
                                             " WHERE RITE03='" + ddl_art.SelectedValue.ToString() + "'" +
                                             " AND RIDR03='" + ddl_tipo.SelectedValue.ToString() + "'" +
                                             " AND RCEN03='" + ddl_ctro.SelectedValue.ToString() + "'" +
                                             " AND RCDI03=" + txt_codigo.Text;
        ...
        protected void b_guardar_Click(object sender, EventArgs e)
        {
            ...
            if (param == 1)
            {
                query.CommandText = "INSERT INTO PANLXUSRF.ORDPF003 " +
                        "(RIDR03," +
                        "RCDI03," +
                        "RDIN03," +
                        "RIUM03," +
            ...
            {
                //query.CommandText = "UPDATE cargos " +
                //    "SET CARGO_NOMBRE='" + txt_descripcion.Text + "', " +
                //    "CARGO_ESTATUS=" + ddl_est.SelectedValue.ToString() + ", " +
                //    "USR_MOD='" + usuario + "'," +
                //    "FECHA_MOD= getdate()" +
                //    " WHERE CIA_CODIGO='" + @cia + "' AND " +
                //            "ID_PAIS=" + @li_pais + " AND " +
                //            "TIPNOM_CODIGO=" + ddl_tpnom.SelectedValue.ToString() + " AND " +
                //            "CARGO_CECOST_CODIGO='" + ddl_cc.SelectedValue.ToString() + "' AND " +
                //            "CARGO_CODIGO='" + txt_codigo.Text + "'";
            }
